...
<form method="POST" action="{{route('parameterization.paymentunitsUpdate', $paymentUnit['id'])}}">
    @csrf
    {{ method_field('PUT') }}
    <div class="form-group row">
        <label for="payment_units" class="col-md-4 col-form-label text-md-right">Nombre de la unidad de pago</label>
        <div class="col-md-6">
            <input id="payment_units" type="text" class="form-control" name="payment_units" required autofocus value="{{$paymentUnit['payment_units']}}">
        </div>
    </div>
