...
<div class="card shadow">
  <div class="card-header">
    ...
    @if(in_array(13, $authPermisos))
      <li class="nav-item">
        <a class="nav-link {{ (request()->is('parameterization/modules')) ? 'active' : '' }}" href="{{route('parameterization.modules')}}">Lista de módulos</a>
      </li>
    @endif
    ...
    @if(in_array(15, $authPermisos))
      <li class="nav-item">
        <a class="nav-link {{ (request()->is('parameterization/modulesCreate')) ? 'active' : '' }}" href="{{route('parameterization.modulesCreate')}}">Crear módulo</a>
      </li>
    @endif
