...
<div class="row justify-content-center">
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('binnacle.index')}}" class="form-inline">
                    @csrf
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="col-md-12">
                                <select class="form-control" id="filter_actions" name="filter_actions">
                                    ...
                                    <option value="{{$uniqueAction['binnacle_action']}}">
                                        {{$uniqueAction['binnacle_action']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="col-md-12">
                                <select class="form-control" id="filter_tables" name="filter_tables">
                                    ...
                                    <option value="{{$uniqueTable['binnacle_tableName']}}">
                                        {{$uniqueTable['binnacle_tableName']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
    ...
    <div class="col-auto">
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#binnacleModal_{{$binnacle['id']}}">
                                Ver detalles
                            </button>
                        </td>
        ...
        <!-- Modal -->
        @foreach ($binnacles as $binnacle)
        <div class="modal fade" id="binnacleModal_{{$binnacle['id']}}" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="table-responsive my-3">
                            <table class="table table-hover w-auto text-nowrap btTable" data-click-to-select="true"
                                data-show-columns="true" data-sortable="true" data-search="true" data-live-search="true"
                                data-search-align="right">
                                <thead>
                                    <tr>
                                        @foreach ($binnacle['binnacle_tablePreValues'] as $preKey => $preValue)
                                        <th scope="col" data-field="pre_{{$preKey}}" data-sortable="true">{{$preKey}}
                                        </th>
                                        @endforeach
                                    </tr>
                                </thead>
                            ...
                            <table class="table table-hover w-auto text-nowrap btTable" data-click-to-select="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" data-field="post_{{$postKey}}" data-sortable="true">{{$postKey}}
                                        </th>
                                        @endforeach
                                    </tr>
                                </thead>
