...
<div class="row justify-content-center">
  ...
  <form method="GET" id="inputPeriodoForm" action="{{ route('billings.managerExport', $periodo) }}">
    ...
    <br>
    <form method="POST" action="{{ route('billings.managerExport', $periodo) }}">
        @csrf
        {{ method_field('PUT') }}
        ...
        <div class="my-3">
            <div class="alert alert-info" role="alert">
                ...
                <div class="form-group row">
                    <div class="col-2">
                        <button type="button" class="btn btn-primary" onclick="assignNumeroFacturas()">
...
function assignNumeroFacturas() {
    ...
    if (Number.isNaN(numeroInicial) || numeroInicial < 0) {
        ...
        for (let i = 0; i < numRows; i++) {
            ...
            // Primera iteración
            if (i == 0) {
                table.tBodies[0].rows[i].children[6].children[0].value = numeroInicial;
                table.tBodies[0].rows[i].children[6].children[2].innerText = numeroInicial;
            } else {
