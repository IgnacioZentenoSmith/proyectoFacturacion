...
<div class="row justify-content-center">
    ...
    <form method="GET" id="inputPeriodoForm" action="{{ route('contracts.quantities', [$contract['id'], $periodo]) }}">
        @csrf
        {{ method_field('GET') }}
            ...
            <table id="tablaQuantities" class="table table-hover w-auto text-nowrap" data-show-export="true"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="quantitiesCantidad[{{$contractCondition['id']}}]" type="number" class="form-control" 
